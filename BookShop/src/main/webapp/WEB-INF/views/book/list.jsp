...
<body>
	<div class="container">
		...
		<div>
			<form>
				<div class="row mb-2"> <!-- mb-2 : margin bottom 2 -->
					<div class="col-6"></div> <!-- col-4는 12에서 4만큼이니까, 1/3을 주겠다, col-6은 12에서 6만큼이니까, 절반 만큼을 주겠다 -->
					<div class="col">
						<select name="search" class="form-select form-select-sm"> <!-- sm:크기 줄임 -->	
					...
					<div class="col-1 d-grid"> <!-- col-1은 12에서 1만큼 사용 -->
